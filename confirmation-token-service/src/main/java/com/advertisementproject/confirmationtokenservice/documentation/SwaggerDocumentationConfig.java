package com.advertisementproject.confirmationtokenservice.documentation;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket api() {
        ApiInfo DEFAULT_API_INFO = new ApiInfo(
                "Confirmation Token Service Api Documentation",
                "Management service for confirmation tokens",
                "1.0",
                null,
                DEFAULT_CONTACT,
                null,
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.advertisementproject.confirmationtokenservice"))
