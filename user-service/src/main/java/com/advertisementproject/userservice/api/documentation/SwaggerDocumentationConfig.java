package com.advertisementproject.userservice.api.documentation;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket api() {
        ApiInfo DEFAULT_API_INFO = new ApiInfo(
                ...
                "Service for registration and management of users",
                "1.0",
                null,
                DEFAULT_CONTACT,
                null,
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.advertisementproject.userservice"))
