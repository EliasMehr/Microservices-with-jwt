package com.advertisementproject.permissionsservice.documentation;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket api() {
        ApiInfo DEFAULT_API_INFO = new ApiInfo(
                "Permissions Service Api Documentation",
                "Management service for user permissions",
                "1.0",
                null,
                DEFAULT_CONTACT,
                null,
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.advertisementproject.permissionsservice"))
