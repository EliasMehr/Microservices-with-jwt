package com.advertisementproject.permissionservice.swagger;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("Permission Service manages permissions for users. Only admin users have access to the endpoints. " +
                        "Normally permission will be automatically created when users confirm their email and deleted if a user deletes their account. " +
